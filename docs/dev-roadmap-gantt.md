...
gantt
  ...
  section M3 タイポグラフィ(#15/#16/#96後)
    ...
    33 TAKEOVERタイポ譜割り    :crit, i33, after i20 i23 i29 i31, 1d
...
- Issueの総数は107件である。内訳は M0=7、新M1=14、新M2=16、新M3=14、M4=14、M5=11、M6=8、M7=11、M8=4、M9=8。M6が8件なのは #112 プレイ中の一時停止オーバーレイを含むためである。新M2の #105 は舞台土台3Dモデルの読込・配置、M7の #106 は舞台土台モデルの素材源・出典・規約確認（保留）である。
- 追跡する107件のうち、提出に必要なのは M0 から M7 と M9 である。M8 横展開の4件（#88・#89・#90・#91）は任意であり、提出を律速しない。
