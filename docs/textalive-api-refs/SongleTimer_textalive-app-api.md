---
source: "https://developer.textalive.jp/packages/textalive-app-api/classes/SongleTimer.html"
ID:
createdAt: "2026-05-29T19:23:37+09:00"
---
## Class SongleTimer

**Songle timer**

Songle API を利用した [Timer](https://developer.textalive.jp/packages/textalive-app-api/interfaces/Timer.html) の実装:

- コンストラクタのオプション [SongleTimerOptions](https://developer.textalive.jp/packages/textalive-app-api/interfaces/SongleTimerOptions.html) で `accessToken` などを指定することで Songle Sync 対応になります
- [PlayerEventListener.onTimerReady](https://developer.textalive.jp/packages/textalive-app-api/interfaces/PlayerEventListener.html#onTimerReady) イベントが呼ばれたら [SongleTimer.songlePlayer](https://developer.textalive.jp/packages/textalive-app-api/classes/SongleTimer.html#songlePlayer) プロパティで Songle API の `Player` インスタンスにアクセスできます

A [Timer](https://developer.textalive.jp/packages/textalive-app-api/interfaces/Timer.html) implementation using Songle API:

- Constructor option [SongleTimerOptions](https://developer.textalive.jp/packages/textalive-app-api/interfaces/SongleTimerOptions.html) with `accessToken` property enables Songle Sync
- After [PlayerEventListener.onTimerReady](https://developer.textalive.jp/packages/textalive-app-api/interfaces/PlayerEventListener.html#onTimerReady) event is emitted, [SongleTimer.songlePlayer](https://developer.textalive.jp/packages/textalive-app-api/classes/SongleTimer.html#songlePlayer) will provide Songle API `Player` instance

#### See

[https://api.songle.jp/](https://api.songle.jp/)
...
- Songleのプレイヤーインスタンスです。
	#### Returns SonglePlayer
	#### See
	[https://api.songle.jp/references/javascript#Player](https://api.songle.jp/references/javascript#Player)
