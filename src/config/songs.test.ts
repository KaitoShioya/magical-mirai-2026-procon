...
// シャッターチャンス（Issue #88）・こたえて（Issue #90）・世界最後の音楽隊（Issue #89）を実装した。これで課題曲6曲すべてが
// 実装済みになり、未実装の曲は無い。曲を増やすときはこの集合とともに、題名画面からの曲選択（selectSong）と
// 曲依存結線の差し替えが揃っている必要がある。
const IMPLEMENTED_SONG_KEYS = [
  "takeover",
  "after-the-curtain",
  "toritsuku-logy",
  "shutter-chance",
