...
// シャッターチャンス（Issue #88）・世界最後の音楽隊（Issue #89）を実装した。曲を増やすときはこの集合とともに、
// 題名画面からの曲選択（selectSong）と曲依存結線の差し替えが揃っている必要がある。
const IMPLEMENTED_SONG_KEYS = ["takeover", "after-the-curtain", "toritsuku-logy", "shutter-chance", "sekai-saigo"];

describe("SONGS の実装可否", () => {
  it("実装済みは TAKEOVER・アフター・ザ・カーテン・トリツクロジー・シャッターチャンス・世界最後の音楽隊の5曲で、他1曲は未実装である", () => {
