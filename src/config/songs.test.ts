...
// シャッターチャンス（Issue #88）・こたえて（Issue #90）を実装した。曲を増やすときはこの集合とともに、題名画面からの曲選択（selectSong）と
// 曲依存結線の差し替えが揃っている必要がある。
const IMPLEMENTED_SONG_KEYS = ["takeover", "after-the-curtain", "toritsuku-logy", "shutter-chance", "kotaete"];

describe("SONGS の実装可否", () => {
  it("実装済みは TAKEOVER・アフター・ザ・カーテン・トリツクロジー・シャッターチャンス・こたえての5曲で、他1曲は未実装である", () => {
