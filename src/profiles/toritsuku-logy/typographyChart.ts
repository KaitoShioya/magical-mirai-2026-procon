// トリツクロジーのタイポ・コンポジション譜面データ（横展開。TAKEOVER の typographyChart.ts と同形）。
//
...
export const TORITSUKU_LOGY_DEFAULT_READING_REGION: TypographyDisplayRegion = {
  centerXRatio: 0.5,
  centerYRatio: 0.72,
  widthRatio: 0.86,
  heightRatio: 0.16,
...
export const TORITSUKU_LOGY_DEFAULT_READING_PIXEL_HEIGHT = 48;

/**
 * トリツクロジーのタイポ譜面。当面は既定採用に任せ、曲固有の上書きと配置は空とする。
 */
export const toritsukuLogyTypographyChart: TypographyChart = {
  effectOverrides: [],
  readingPlacements: [],
};
